        ...
        <header className='col-span-1'>
            <nav className='bg-slate-900 h-full flex flex-col'>
                <div className='text-white text-xl'>
                    ...
                    <div
                        className={`hover:bg-slate-800 ease-in-out duration-300 p-2 m-2 cursor-pointer rounded-md flex items-center justify-center gap-1 ${active === 'home' ? 'bg-slate-800' : 'bg-slate-700'}`}
                        onClick={() => props.onButtonClick('home')}>
                        <BiSolidHome className='inline flex-shrink-0' />
                        <span className='md:inline hidden'>Home</span>
                    </div>
                    <div
                        className={`hover:bg-slate-800 ease-in-out duration-300 p-2 m-2 cursor-pointer rounded-md flex items-center justify-center gap-1 ${active === 'about' ? 'bg-slate-800' : 'bg-slate-700'}`}
                        onClick={() => props.onButtonClick('about')}>
                        <MdInfo className='inline flex-shrink-0' />
                        <span className='md:inline hidden'>About</span>
                    </div>
                    <div
                        className={`hover:bg-slate-800 ease-in-out duration-300 p-2 m-2 cursor-pointer rounded-md flex items-center justify-center gap-1 ${active === 'services' ? 'bg-slate-800' : 'bg-slate-700'}`}
                    ...
                    <div
                        className={`hover:bg-slate-800 ease-in-out duration-300 p-2 m-2 cursor-pointer rounded-md flex items-center justify-center gap-1 ${active === 'pricing' ? 'bg-slate-800' : 'bg-slate-700'}`}
